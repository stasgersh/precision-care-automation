...
Instance: --PATIENT.ID.2--
InstanceOf: Patient
Usage: #inline
* name.use = #official
* name.family = "TEST_PS"
* name.given = "SmartSch2"
* gender = #male
 ...
 *************************************************************/
Instance: --DIAGNOSTIC.REPORT.ID.3--
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
* category.text = "Radiology"
* subject = Reference(Patient/--PATIENT.ID.2--)
 ...
 * AI summary of this report is present in 'Brief history'
 *************************************************************/
Instance: --DOCUMENT.REFERENCE.ID.2--
...
* context.encounter = Reference(--ENCOUNTER.ID.2--)

/**************************************************************
 * Encounter (cut date)
 *************************************************************/
Instance: --ENCOUNTER.ID.2--
 ...
 *************************************************************/
Instance: --DIAGNOSTIC.REPORT.ID.4--
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
