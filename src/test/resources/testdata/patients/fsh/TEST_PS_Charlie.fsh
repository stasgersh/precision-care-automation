...
Instance: sLpokXQEPjo8AfP9CxDgyy
InstanceOf: Patient
Usage: #inline
* name.use = #official
* name.family = "TEST_PS"
 ...
 *************************************************************/
Instance: 2xLzcJas2NXQsCZYgTGNLF
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
* category.text = "Radiology"
* subject = Reference(Patient/sLpokXQEPjo8AfP9CxDgyy)
 ...
 * AI summary of this report is present in 'Brief history'
 *************************************************************/
Instance: 9gk39bByqAN1FtcFW8xJq6
...
* context.encounter = Reference(fUGKdkQAiYy9jZnBL4MDcZ)

/**************************************************************
 * Encounter (cut date)
 *************************************************************/
Instance: fUGKdkQAiYy9jZnBL4MDcZ
 ...
 *************************************************************/
Instance: aJ4dbYhBxyo8Fy2CXYJXv4
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
