...
Instance: 60582248-828f-45cb-a9e3-79829b5a0859
InstanceOf: Patient
Usage: #inline
* name.use = #official
* name.family = "TEST_PS"
 ...
 *************************************************************/
Instance: 9d8144a7-2144-479a-815e-7f9336f7c815
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
* category.text = "Radiology"
* subject = Reference(60582248-828f-45cb-a9e3-79829b5a0859)
* effectiveDateTime = "2009-08-08T16:31:51.000Z"
 ...
 * AI summary of this report is present in 'Bried history'
 *************************************************************/
Instance: a0a73e19-148d-469d-a040-ac80025dd994
...
* context.encounter = Reference(232b1902-bb30-4187-a436-034c23781b8e)

/**************************************************************
 * Encounter (cut date)
 *************************************************************/
Instance: 232b1902-bb30-4187-a436-034c23781b8e
...
* participant.period.start = "2009-09-09T17:31:51.000Z"
* participant.period.end = "2009-09-09T17:51:51.000Z"
* participant.individual = Reference(oB5eYSINJa30) "Dr. Bianca Matrey"
* period.start = "2009-09-09T17:31:51.000Z"
* period.end = "2009-09-09T17:51:51.000Z"

/**************************************************************
 * DocumentReference after the cut date
 *************************************************************/
Instance: 99c27a75-f67d-4fda-acb4-8ae09c698678
InstanceOf: DocumentReference
Usage: #inline
* status = #current
* category = $us-core-documentreference-category#clinical-note "Clinical Note"
...
* author.type = "Practitioner"
* subject = Reference(60582248-828f-45cb-a9e3-79829b5a0859)
* date = "2009-10-01T10:55:12.000Z"

/**************************************************************
 * DiagnosticReport with images after the cut date
 *************************************************************/
Instance: 5a2afc4d-7b5e-42f9-b20a-6bbf77e34f80
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
* category.text = "Radiology"
* subject = Reference(Patient/60582248-828f-45cb-a9e3-79829b5a0859)
* effectiveDateTime = "2009-10-02T10:22:22.000Z"
* conclusion = "STABLE"
* presentedForm.contentType = #text/plain
...
* imagingStudy = Reference(86af7415-0331-4fef-af36-e5607275a49f)
* result = Reference(14c0a412-b0a8-4ad5-b27c-e8ed961010c0)

/*** Imaging study for DiagnosticReport 5a2afc4d-7b5e-42f9-b20a-6bbf77e34f80 ***/
Instance: 86af7415-0331-4fef-af36-e5607275a49f
...
/*** Observation for DiagnosticReport 5a2afc4d-7b5e-42f9-b20a-6bbf77e34f80 ***/
Instance: 14c0a412-b0a8-4ad5-b27c-e8ed961010c0
 ...
 *************************************************************/
Instance: 0c3abd1c-2c39-4eee-bd72-34bb92556512
InstanceOf: DiagnosticReport
Usage: #inline
...
* category.text = "Radiology"
* subject = Reference(60582248-828f-45cb-a9e3-79829b5a0859)
* effectiveDateTime = "2009-10-11T11:22:22.000Z"
* conclusion = "STABLE"
* presentedForm.contentType = #text/plain
 ...
 *************************************************************/
Instance: 9b2cae39-13d8-4914-b8b6-ea00f094c051
InstanceOf: Observation
Usage: #inline
* status = #final
...
* subject = Reference(60582248-828f-45cb-a9e3-79829b5a0859)
* effectiveDateTime = "2009-11-28T10:55:12.000Z"
* issued = "2009-11-28T10:55:12.000Z"
* valueQuantity = 47.3 'kg' "kg"
* note.text = "Body Weight 66.1 kg"

/**************************************************************
 * DiagnosticReport after the cut date
 *************************************************************/
Instance: 38fd6673-6473-4c97-aa27-44b888b2eec3
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* subject = Reference(60582248-828f-45cb-a9e3-79829b5a0859)
* effectiveDateTime = "2010-02-04T10:55:12.000Z"
