...
* context.encounter = Reference(OmSP7wO0r3hL)

/**************************************************************
 * Encounter (cut date)
 *************************************************************/
Instance: OmSP7wO0r3hL
 ...
 *************************************************************/
Instance: 4gwTtmTd8o04
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* category = $loinc#LP29684-5 "Radiology"
* category.text = "Radiology"
* subject = Reference(Patient/RgBoq3dEISxh)
* effectiveDateTime = "2007-10-02T10:22:22.000Z"
* conclusion = "STABLE"
* presentedForm.contentType = #text/plain
...
* imagingStudy = Reference(bYraM1ZUkhSc)
* result = Reference(GC5deOZpWmqh)

/*** Imaging study for DiagnosticReport 4gwTtmTd8o04 ***/
Instance: bYraM1ZUkhSc
...
/*** Observation for DiagnosticReport 4gwTtmTd8o04 ***/
Instance: GC5deOZpWmqh
...
* subject = Reference(RgBoq3dEISxh)
* effectiveDateTime = "2007-11-28T10:55:12.000Z"
* issued = "2007-11-28T10:55:12.000Z"
 ...
 * DiagnosticReport after the cut date
 *************************************************************/
Instance: WLorIIO2sE7c
InstanceOf: DiagnosticReport
Usage: #inline
* status = #final
* subject = Reference(RgBoq3dEISxh)
* effectiveDateTime = "2008-02-04T10:55:12.000Z"
...
/**************************************************************
 * Procedure after the cut date
 * In current configuration, this event is not displayed
 * in 'What has changed since last oncology encounter' table
 *************************************************************/
Instance: fxRPhVZonuyd
InstanceOf: Procedure
Usage: #inline
* status = #completed
* code = $sct#288086009 "Suture open wound"
* code.text = "Suture open wound"
* subject = Reference(RgBoq3dEISxh)
* performedPeriod.start = "2008-04-08T14:18:42.000Z"
* performedPeriod.end = "2008-04-08T14:54:42.000Z"
* note.text = "Suture open wound"
