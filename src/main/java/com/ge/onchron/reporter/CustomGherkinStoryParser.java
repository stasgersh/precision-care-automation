...
public class CustomGherkinStoryParser extends TransformingStoryParser {

    public CustomGherkinStoryParser(){
        this(new RegexStoryParser());
    }

    public CustomGherkinStoryParser( StoryParser delegate){
        super(delegate, new CustomGherkinTransformer());
    }

    public static class CustomGherkinTransformer implements StoryTransformer {

        private LocalizedKeywords keywords;

        public CustomGherkinTransformer() {
            this(new LocalizedKeywords());
        }

        public CustomGherkinTransformer(LocalizedKeywords keywords) {
            ...
            Formatter formatter = new Formatter(){
                ...
                public void step(Step step) {
                    out.append(step.getKeyword())
                       .append(step.getName())
                       .append("\n");
                    // Customization: docString is added to the step to handle multiline steps
                    if (step.getDocString() != null){
                        out.append(step.getDocString().getValue())
                           .append("\n");
                    }
